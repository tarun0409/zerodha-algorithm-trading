...
tickers = ["ICICIBANK.BO","SBIN.BO","WIPRO.BO","TATAMOTORS.BO","IOC.BO", "INFRATEL.BO","ITC.BO","ZEEL.BO","ONGC.BO","NTPC.BO"]


ohlc_intraday = {}
#start = dt.datetime.today()-dt.timedelta(1865)
    ...
    for i in range(len(tickers)):
        try:
           # ohlc_intraday[tickers[i]] = ts.get_intraday(symbol=tickers[i],interval='5min', outputsize='full')[0]
            ohlc_intraday[tickers[i]] = yf.download(tickers[i])
